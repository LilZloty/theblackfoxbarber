        ...
        <Image className='opacity-40'
            ...
            />
             <div className="flex items-center justify-center absolute inset-0">
              <h1 className='pb-20'> Experience the Best Haircuts in Guadalajara with The Black Fox Barber!</h1>
               </div>
               
                <div className="flex items-center justify-center absolute inset-0 pt-20 pb-20">
